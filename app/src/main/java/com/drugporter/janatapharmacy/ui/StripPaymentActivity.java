...
public class StripPaymentActivity extends AppCompatActivity {
    ...
    com.drugporter.janatapharmacy.model.PaymentItem paymentItem;
    double amount = 0.0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentItem = (com.drugporter.janatapharmacy.model.PaymentItem) getIntent().getSerializableExtra("detail");
